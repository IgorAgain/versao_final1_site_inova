...
// Dados dos serviços POP UPS NA SESSÃO SERVIÇOS
const servicosData = {
    acessos: {
        title: "Controle de Acessos",
        subtitle: "Tecnologia biométrica e RFID avançada",
        description: "Nosso sistema de controle de acessos oferece segurança máxima para sua empresa através de tecnologia biométrica de última geração, cartões RFID e integração com sistemas existentes. Controle total sobre quem entra e sai, com relatórios detalhados e monitoramento em tempo real.",
        features: [
            {
                icon: "fas fa-fingerprint",
                title: "Biometria Avançada",
                description: "Reconhecimento facial e digital com precisão de 99.9% e velocidade de resposta instantânea."
            },
            {
                icon: "fas fa-id-card",
                title: "Cartões RFID",
                description: "Sistema de cartões inteligentes com criptografia avançada e controle de permissões por área."
            },
            {
                icon: "fas fa-chart-line",
                title: "Relatórios Detalhados",
                description: "Acompanhe acessos em tempo real com relatórios customizáveis e alertas automáticos."
            }
        ],
        images: [
            "Catraca Biométrica",
    ...
    aplicativos: {
        ...
        subtitle: "Soluções móveis para iOS e Android",
        description: "Criamos aplicativos móveis sob medida para sua empresa, com design intuitivo, performance otimizada e funcionalidades que realmente fazem diferença no seu negócio. Do conceito ao lançamento, cuidamos de cada detalhe.",
        features: [
            {
                icon: "fas fa-code",
                title: "Desenvolvimento Nativo",
                description: "Apps nativos para iOS e Android com performance máxima e experiência otimizada."
            },
            {
                icon: "fas fa-paint-brush",
                title: "Design Personalizado",
                description: "Interface única e intuitiva criada especificamente para sua marca e usuários."
            },
            {
                icon: "fas fa-sync-alt",
                title: "Integração Completa",
                description: "Sincronização com seus sistemas existentes e APIs de terceiros."
            }
        ],
        images: [
            "Mockup iPhone",
    ...
    ponto: {
        ...
        subtitle: "Gestão completa de horários e jornada",
        description: "Sistema completo para controle de ponto eletrônico que atende todas as exigências trabalhistas. Gestão automatizada de horários, cálculo de horas extras, banco de horas e relatórios gerenciais completos.",
        features: [
            {
                icon: "fas fa-clock",
                title: "Ponto Eletrônico",
                description: "Registro de ponto via biometria, cartão ou aplicativo móvel com validação segura."
            },
            {
                icon: "fas fa-calculator",
                title: "Cálculos Automáticos",
                description: "Processamento automático de horas trabalhadas, extras e banco de horas."
            },
            {
                icon: "fas fa-file-alt",
                title: "Relatórios Gerenciais",
                description: "Dashboards completos com indicadores de produtividade e presença."
            }
        ],
        images: [
            "Terminal de Ponto",
...
document.addEventListener('DOMContentLoaded', function() {
    const buttons = document.querySelectorAll('.servico-cta-servicos');
    buttons.forEach(button => {
        button.addEventListener('click', function() {
            const servico = this.getAttribute('data-servico');
            if (servico && servicosData[servico]) {
                openPopup(servico);
            }
        });
    });
...
function openPopup(servicoKey) {
    const servico = servicosData[servicoKey];
    if (!servico) return;

    // Preencher conteúdo
    popupTitle.textContent = servico.title;
    popupSubtitle.textContent = servico.subtitle;
    popupDescription.textContent = servico.description;

    // Limpar e preencher features
    popupFeatures.innerHTML = '';
    servico.features.forEach(feature => {
    ...
    servico.images.forEach((imageName, index) => {
        ...
        popupGallery.appendChild(imageElement);
    });
...
// Prevenir scroll do body quando popup estiver aberto
popupOverlay.addEventListener('wheel', function(e) {
    e.preventDefault();
});